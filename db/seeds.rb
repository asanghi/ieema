...
oa.formula_components.create(:weight => 15, :commodity => labour,
                             :billing_month_difference => 4,
                             :tender_month_difference => 4)
...
hla.formula_components.create(:weight => 11, :commodity => labour,
                              :billing_month_difference => 4,
                              :tender_month_difference => 4)
...
oha.formula_components.create(:weight => 11, :commodity => labour,
                              :billing_month_difference => 4,
                              :tender_month_difference => 4)
...
olaz.formula_components.create(:weight => 11, :commodity => labour,
                               :billing_month_difference => 4,
                                :tender_month_difference => 4)
...
workbook.worksheets.each do |ws|
  ...
  ws.each(1) do |row|
    date = row.at(0).date
    value = row.at(1).to_s('latin1').to_f
